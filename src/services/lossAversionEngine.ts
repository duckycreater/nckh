...
const REGRET_LIBRARY_VI: RegretPrompt[] = [
  {
    ...
    recovery: {
      id: "vi.rec.1",
      text: "Sắp xếp 1 lần quét trong hôm nay để bắt đầu lại.",
      deadlineDays: 1,
    },
  ...
  },
  {
    ...
    recovery: {
      id: "vi.rec.2",
      text: "Quét 5 mục bất kỳ ngay bây giờ — chỉ trong 90 giây.",
      deadlineDays: 1,
    },
  ...
  },
  {
    ...
    recovery: {
      id: "vi.rec.3",
      text: "Hoàn thành 1 quiz 5 câu để khôi phục điểm.",
      deadlineDays: 1,
    },
...
const REGRET_LIBRARY_EN: RegretPrompt[] = [
  {
    ...
    recovery: {
      id: "en.rec.1",
      text: "Schedule one scan today to start a fresh streak.",
      deadlineDays: 1,
    },
    reason: "streak_broken_gentle",
  },
  {
    ...
    recovery: {
      id: "en.rec.2",
      text: "Scan 5 items right now — it takes only 90 seconds.",
      deadlineDays: 1,
    },
    reason: "inactivity_2d",
  },
  {
    ...
    recovery: {
      id: "en.rec.3",
      text: "Complete a 5-question quiz to restore progress.",
      deadlineDays: 1,
    },
    reason: "streak_break_3d",
  },

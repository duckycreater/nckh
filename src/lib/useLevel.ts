...
export const TIER_NAMES: Record<
  string,
  { short: string; full: string; emoji: string; color: string }
> = {
...
export const MILESTONE_LEVELS: MilestoneDef[] = [
  ...
  { threshold: 1500, bonus: 200, label: "Legend", labelVi: "Huyền Thoại", tier: "t7" },
  {
    ...
    bonus: 300,
    label: "Gaia Chosen",
    labelVi: "Người Được Gaia Chọn",
    tier: "t9",
  },
  {
    threshold: 4000,
    bonus: 500,
    label: "Earth Champion",
    labelVi: "Vô Địch Trái Đất",
    tier: "t11",
  },
